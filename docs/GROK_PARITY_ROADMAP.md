...
**Current baseline:** CodeForge **v1.9.5**  
...
> **Status sync:** last updated for **v1.9.3** + audit phases **Q0–Q7**.  
> Detail for each phase is in the body of this doc; this section is the at-a-glance status only.  
> Post-parity quality track: see [`AUDIT_AND_ROADMAP.md`](./AUDIT_AND_ROADMAP.md) (Q0–Q6 + **Q7 perf**).
