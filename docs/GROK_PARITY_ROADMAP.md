...
**Current baseline:** CodeForge **v1.5.0**  
- Phase 0–9 + **G1–G7** (… subagents/personas, **background subagents**)  
- Honest gaps remain as **Could** (process-wide Landlock, full x.ai/* ACP)
